...
public class CustomerWindow extends JFrame {
    ...
    private CustomerBusiness customerBussines;
    ...
    private void create() {
        ...
        try {
            customerBussines.create(c);
            JOptionPane.showMessageDialog(this, "Customer successfully added!");
            this.cleanPanelData();
            this.table.setModel(new CustomerTableModel(customerBussines.read()));
    ...
    private void update() {
        Customer c = customerBussines.read().stream().filter(e -> e.getId().equals(new Long(id.getText()))).findAny().get();
        Country selected = countryBusiness.read().stream().filter(e -> e.getName().equalsIgnoreCase((String) country.getSelectedItem())).findFirst().get();
    ...
    private void delete() {
        ...
        try {
            customerBussines.delete(new Long(id.getText()));
    ...
    public CustomerWindow(CustomerBusiness customerBussines, CountryBusiness countryBusiness) {
        this.customerBussines = customerBussines;
        ...
        table = new JTable();
        table.setModel(new CustomerTableModel(customerBussines.read()));
